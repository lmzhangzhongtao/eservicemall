package com.caspar.eservicemall.cart.web;
...
public class CartController {
    ...
    public String addCartItem(@RequestParam("skuId") Long skuId,
        ...
        return "redirect:http://cart.eservicemall.com/addToCartSuccessPage.html";
    }
    /**
     * 商品添加购物车成功页（防刷）
     */
    ...
    public String checkItem(@RequestParam(value = "skuId") Long skuId,
        ...
        return "redirect:http://cart.eservicemall.com/cart.html";
    }
